    ...
    return (
        <>
            ...
            <header className="navbar">
                ...
                <h1 className="nav-title">Gestão de Vendas</h1>
            ...
            <div id="delete-modal" className={`modal-backdrop ${isDeleteModalOpen ? '' : 'hidden'}`}>
                <div className="modal-card small-card">
                    ...
                    <p style={{ color: '#d1d5db', lineHeight: '1.6' }}>
                        ...
                        <strong id="sale-name-to-delete" className="text-yellow-400 font-bold block mt-2 text-lg">{saleToDelete?.nome}</strong>
                    </p>
